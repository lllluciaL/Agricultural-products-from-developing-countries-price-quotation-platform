          ...
          xAxisData.push(...uniqueCountries);
           // 根据dataByCountry对象计算箱线图的数据
            Object.keys(dataByCountry).forEach(country => {
              ...
              seriesData.push([min, max, q1, median, q3,...dataByCountry[country]]);
            });
          ...
          const option = {
            tooltip: {
              ...
              formatter: function(params) {
                ...
                const max = params[0].data[2];
                const q1 = params[0].data[3];
                const median = params[0].data[4];
                const q3 = params[0].data[5];
